...
# Aggregates all issues from the five Layer 1 agents, sorts them by severity (high → medium → low), and asks the LLM to write a concise executive summary highlighting the most critical problems and their business impact.
