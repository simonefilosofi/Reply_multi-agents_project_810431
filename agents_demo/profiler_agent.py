...
class ProfilerAgent(BaseAgent):
    ...
    INSTRUCTION = (
        ...
        "date_columns must include period codes (YYYYMM like 202401, YYYYMMDD) "
        "and any column whose values represent a point or span in time — even if "
        "stored as integers or floats. "
